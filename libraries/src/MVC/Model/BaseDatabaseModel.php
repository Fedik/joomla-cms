    ...
    CacheControllerFactoryAwareInterface
{
    ...
    {
        @trigger_error(sprintf('Method %s is deprecated, use getDatabase() instead.', __METHOD__), E_USER_DEPRECATED);
    ...
    {
        @trigger_error(sprintf('Method %s is deprecated, use setDatabase() instead.', __METHOD__), E_USER_DEPRECATED);
